...
1. Read `spec.md` for any preexisting context. Read the task source thoroughly.

2. **Codebase research substep.** Before the interactive Q&A, dispatch a documentarian-mode subagent (typically `Explore` or `general-purpose`) to answer 3-5 neutral questions about how the relevant areas of the codebase currently work. Frame the questions in terms of existing components and flows, not the desired feature — the subagent should describe what exists, not propose how to change it.
...
3. **Interactive Q&A.** Ask one question at a time to develop the spec, grounded in `research.md`. Each question should build on previous answers. Propose your best judgment with the trade-offs from research, and ask to confirm or adjust — don't ask open-ended questions when you have a clear recommendation. Multiple choice preferred when feasible.
